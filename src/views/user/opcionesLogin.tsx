...
const OpcionesLogin = ({ closeModalLogin, handleLogin, closeModalRegistro, handleChangeFormLogin, handleCodeLogin, handleLoginCorreoContrasena }) => {
        ...
        <Row>
            <Col>
                <div style={{ paddingLeft: "2%", paddingRight: "2%" }}>
                    ...
                    >
                        <h5 style={{ color: "#fc5241" }}>Elija una opción para ingresar</h5>
                    </div>
