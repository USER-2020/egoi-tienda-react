...
const DetailCartNoToken = ({
  ...
  const sumSubTotal = (productsCart) => {
    ...
    productsCart.map((product) => {
      if (product.discount > 0) {
        const precioTotal =
          (product.unit_price - product.discount) * product.min_qty;
        total += precioTotal;
      }
  ...
  const handleDecrement = (quantityUPD, idProd) => {
    ...
    // Obtiene los datos actuales del carrito desde el localStorage
    let productsCartWithoutToken = JSON.parse(
      localStorage.getItem("productsCart")
    );

    // Encuentra el producto en el carrito
    const existingProductIndex = productsCartWithoutToken.findIndex(
      (item) => item.id === idProd
    );
    ...
    if (productsCartWithoutToken && existingProductIndex !== -1) {
      ...
      localStorage.setItem(
        "productsCart",
        JSON.stringify(productsCartWithoutToken)
      );
    }
  };
  ...
  useEffect(() => {
    console.log(
      "Productos del carrito en el detail cart sin token ",
      productsInCart
    );
    costoDeENvio();
                        ...
                        products.discount_tag_valor === 0 && (
                          <>
                            <h5>
                              ...
                              $
                              {(
                                products.unit_price * products.min_qty
                              ).toLocaleString("es")}
                            </h5>
                          </>
                        )}
                        ...
                        <>
                          ...
                          >
                            ...
                            <h5>
                              ...
                              $
                              {(
                                (products.unit_price - products.discount) *
                                products.min_qty
                              ).toLocaleString("es")}
                            </h5>
                          </div>
                        ...
                        <>
                          ...
                          >
                            ...
                            <h5>
                              $
                              {(
                                products.discount_tag_valor * products.min_qty
                              ).toLocaleString("es")}
                            </h5>
                          </div>
                        </>
                      ...
                      <div className="cant">
                        ...
                        {products.min_qty >= 2 && (
                          <button
                            className="btnIzq"
                            onClick={() => {
                              setQuantity(products.min_qty);
                              handleDecrement(products.min_qty, products.id);
                              getAllProductsByCartNotoken();
                            }}
                          >
                            <svg
                        ...
                        <button
                          ...
                          onClick={() => {
                            setQuantity(products.min_qty);
                            handleIncrement(products.min_qty, products.id);
                            getAllProductsByCartNotoken();
                          }}
                        >
                          <svg
