                    ...
                    <div className="footerLogo">
                        <div className="izqIconsMedia">
                            ...
                            <div className="iconsRedes">
                                <a href="https://Facebook.com/egoicolombia" target="_blank"><svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                {/* Instagram  */}
                                <a href="https://instagram.com/egoi_colombia" target="_blank"><svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
