                ...
                <div className="contenedorOrdersOpciones">
                    ...
                    <div className="containerMenuAndContenidoMisOrdenes">
                        <div className="menuMisOrdenes">
                            <ul>
                                <li className={`opcion ${activeOption === 'MisPedidos' ? 'active' : ''}`} onClick={() => handleMenuOptionClick('MisPedidos')}>
                                ...
                                <li className={`opcion ${activeOption === 'ListaDeseos' ? 'active' : ''}`} onClick={() => handleMenuOptionClick('ListaDeseos')}>
                                    <svg width="22" height="22" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg" className='img_opcion'>
                                ...
                                <li className={`opcion ${activeOption === 'Chatear' ? 'active' : ''}`} onClick={() => handleMenuOptionClick('Chatear')}>
                                    <svg width="22" height="22" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg" className='img_opcion'>
                                ...
                                <li className={`opcion ${activeOption === 'InfoPerfil' ? 'active' : ''}`} onClick={() => handleMenuOptionClick('InfoPerfil')}>
                                ...
                                <li className={`opcion ${activeOption === 'Direccion' ? 'active' : ''}`} onClick={() => handleMenuOptionClick('Direccion')}>
                                    <svg width="22" height="22" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg" className='img_opcion'>
                                ...
                                <li className={`opcion ${activeOption === 'Ticket' ? 'active' : ''}`} onClick={() => handleMenuOptionClick('Ticket')}>
                                    <svg width="22" height="22" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg" className='img_opcion'>
