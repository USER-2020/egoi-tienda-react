            ...
            <div className="containerDetalle">
                        ...
                        <div className="containerNameAndStarts">
                            ...
                            <div className="stars">
                                {[...Array(5)].map((_, index) => (
                                    <img
                                        key={index}
                                        src={index < detailProducts.count_rating ? start : startEmpty}
                                        alt=""
                                    />
                                ))}
                            </div>
                ...
                <div className="containerDer">
                    <div className="containerResponsiveNameProduct">
                        <div className="containerNameAndStarts">
                            ...
                            <div className="precio">
                                ...
                                {detailProducts.unit_price >= 79900 ? (
                    ...
                    <div className="containerCharacteristicTopResponsive">
                        ...
                        <div className='characteristicResponsive'>{detailProducts.count_orden} Pedidos</div>
                        <div className='characteristicResponsive'>{detailProducts.count_wishlist} Favoritos</div>
                    </div>
