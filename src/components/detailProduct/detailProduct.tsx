...
function DetailProduct({
  ...
  const [
    ...
    setCommentsAndOpinionsProducts,
  ] = useState([]);
      ...
      addProductsCart(
        ...
        .then((res) => {
          ...
          if (detailProducts.discount_valor > 0) {
            discount =
              detailProducts.unit_price - detailProducts.discount_valor;
          }
          if (detailProducts.discount_tag_valor > 0) {
            discount = detailProducts.discount_tag_valor;
          }
          if (
            detailProducts.discount_valor === 0 &&
            detailProducts.discount_tag_valor === 0
          ) {
            discount = 0;
          }
      ...
      items: [
        {
          ...
          coupon: 0,
          discount:
            detailProducts.discount_valor ||
            detailProducts.dicount_tag_valor ||
            0,
          index: 5,
          item_list_name: id,
          item_list_id: id,
  ...
  return (
    <div>
      ...
      {isLoading ? (
        ...
        <div
          style={{ marginTop: "25px", fontSize: "24px", textAlign: "center" }}
        >
        ...
        <>
          <div className="container">
            <div className="containerDetalle">
              <div className="containerIzq">
                    ...
                    <div className="starts">
                      {[...Array(5)].map((_, index) => (
                        <img
                          key={index}
                          src={
                            index < detailProducts.count_rating ? start : startEmpty
                          }
                          alt=""
                        />
                      ))}
                ...
                {detailProducts &&
                  ...
                  detailProducts.images.length > 0 && (
                    <Card className="cardImgProduct">
                      <div className="containerImgTop">
                        <img
                          src={
                            currentImg ||
                            baseUrlImage + detailProducts.images[0]
                          }
                      ...
                      <div className="containerImgMiniature">
                        ...
                        {detailProducts &&
                          detailProducts.images.map((imgProduct, index) => (
                            <img
                              src={baseUrlImage + imgProduct}
                              alt={detailProducts.name}
                              key={index}
                              onClick={() =>
                                setCurrentImage(baseUrlImage + imgProduct)
                              }
                              className={
                                currentImg === baseUrlImage + imgProduct
                                  ? "activeMiniature"
                                  : ""
                              }
                            />
              ...
              <div className="containerDer">
                <div className="containerResponsiveNameProduct">
                  <div className="containerNameAndStarts">
                    <div className="precio">
                      ...
                      detailProducts.discount_valor > 0 ? (
                        ...
                        >
                          <h5>
                            $
                            {(detailProducts.discount_valor &&
                              detailProducts.discount_valor.toLocaleString(
                                "es"
                              )) ||
                              (detailProducts.discount_tag_valor &&
                                detailProducts.discount_tag_valor.toLocaleString(
                                  "es"
                                ))}
                          </h5>
                          <h5 id="tachado">
                            <s>
                              $
                              {detailProducts.unit_price &&
                                detailProducts.unit_price.toLocaleString("es")}
                            </s>
                          </h5>
                        </div>
                      ) : (
                      ...
                      detailProducts.discount_valor >= 79900 ||
                      detailProducts.dicount_tag_valor >= 79900 ? (
                        <div
                          style={{
                            display: "flex",
                            flexDirection: "row",
                    ...
                    <div className="favAndShare">
                      ...
                      <a href="#" onClick={() => handleShare()}>
                        <svg
                          ...
                          height="35"
                          fill="currentColor"
                          className="bi bi-share svgShare"
                          viewBox="0 0 16 16"
                        >
                ...
                <div className="containerCharacteristicTopResponsive">
                  ...
                  <div className="characteristicResponsive">
                    {detailProducts && detailProducts.count_orden} Pedidos
                  </div>
                  <div className="characteristicResponsive">
                    {detailProducts && detailProducts.count_wishlist} Favoritos
                  </div>
                </div>
                {detailProducts &&
                  detailProducts.choice_options &&
                  detailProducts.choice_options.length > 0 && (
                    <div>
                      {detailProducts.choice_options.some(
                        (variations) => variations.title === "Colores"
                      ) && (
                      ...
                      {detailProducts.choice_options.some(
                        (variations) => variations.title === "Tallas"
                      ) && (
                        <div
                          className="containerVariacionesResponsiveColores"
                ...
                <div className="containerResponsiveDescription">
                  ...
                  <p>
                    {detailProducts &&
                    typeof detailProducts.details === "string"
                ...
                <div className="containerCharacteristicTop">
                  ...
                  <div className="characteristic">
                    {detailProducts.count_orden} Pedidos
                  </div>
                  <div className="characteristic">
                    {detailProducts.count_wishlist} Favoritos
                  </div>
                </div>
                <div className="containerNameProduct">
                  ...
                  >
                    ...
                    {(detailProducts && detailProducts.unit_price >= 79990) ||
                    detailProducts.discount_valor >= 79900 ||
                    detailProducts.dicount_tag_valor >= 79900 ? (
                      <div
                        style={{
                  ...
                  detailProducts.choice_options.length > 0 && (
                    <div>
                      ...
                      {detailProducts.choice_options.some(
                        ...
                        <div
                          className="containerColorsProduct"
                          style={{ marginTop: "15px" }}
                        >
                          <p>Tallas: </p>
                          {detailProducts.choice_options
                ...
                <div className="opciones">
                  ...
                  detailProducts.current_stock > 0 ? (
                    ...
                    >
                      <p style={{ textAlign: "center" }}>Comprar ahora</p>
                    </a>
                  )}
                  <a
                    href="#"
                  ...
                  <a
                    href="#"
                    className="fav"
                    onClick={() => favClick(detailProducts.id)}
                  >
                    <svg
                      width="32"
                      height="32"
                    ...
                    <ModalBody>
                      ...
                      detailProducts.current_stock > 0 ? (
                        <AddCart
                          ...
                          detailsProducts={detailProducts}
                          quantity={quantity}
                        />
                      ) : (
                        <NoStock
            ...
            <div className="containerDescription">
              <h5>Descripción</h5>
              <p>
                {detailProducts && typeof detailProducts.details === "string"
                  ? parse(detailProducts.details)
                  : null}
              </p>
            </div>
            <div className="opinions">
              <div className="raitingLeft">
                <div className="raiting">
                  ...
                  <div className="raitingStarts">
                    ...
                    <div className="nrOpinions">
                      {commentsAndOpinionsProducts &&
                      commentsAndOpinionsProducts.length > 0 ? (
                ...
                <div className="stats">
                  ...
                  {ratingStats.starCounts.reverse().map(({ stars, count }) => (
                    <div
                      className={
                        count > 0 ? "stats_raiting" : "stats_raiting_gray"
                      }
                      key={stars}
                    >
                      <img src={start} alt="" />
              ...
              <div className="comments">
                {commentsAndOpinionsProducts &&
                  commentsAndOpinionsProducts.length > 0 &&
                  commentsAndOpinionsProducts.map((item, index) => (
