...
const PasswordNewPasswordComponent = () => {
    ...
    return (
        <div>
            <Card style={{ width: '400px', justifyContent: 'center', textAlign: 'center', padding: '20px' }}>
                ...
                <div className="containerFormInfoProfile">
                    ...
                    <div className="correoInfoPerfil">
                        Actualiza la contraseña para el correo
                        <h6>{email}</h6>
                    </div>
...
export default PasswordNewPasswordComponent
