    ...
    return (
        <>
            <div className='trackOrderView'>
                ...
                {/* Pending */}
                {infoOrderTrack.order_status === 'pending' && (
                ...
                {/* Confirmed */}
                {infoOrderTrack.order_status === 'confirmed' && (
                ...
                {/* Processing */}
                {infoOrderTrack.order_status === 'processing' && (
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '5px', padding: '14px', justifyContent: 'center', textAlign: 'center', alignItems: 'center' }}>
                                ...
                                <div>
                                    <p>
                                        ...
                                        <p style={{ fontSize: '14px', marginBottom: '0' }}>Procesando pedido</p>
                                    </p>
                                </div>
                ...
                {/* Out_for_delivery */}
                {infoOrderTrack.order_status === 'out_for_delivery' && (
                    <Card style={{
                        width: '100%', marginTop: '20px',
                        display: 'flex', flexDirection: 'row',
                        justifyContent: 'space-between'
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '5px', padding: '14px', justifyContent: 'center', textAlign: 'center', alignItems: 'center' }}>
                                ...
                                <div>
                                    <p>
                                        ...
                                        <p style={{ fontSize: '14px', marginBottom: '0' }}>Preparando pedido</p>
                                    </p>
                                </div>
                ...
                {/* Delivered */}
                {infoOrderTrack.order_status === 'delivered' && (
                    <Card style={{
                        width: '100%', marginTop: '20px',
                        display: 'flex', flexDirection: 'row',
                        justifyContent: 'space-between'
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '5px', padding: '14px', justifyContent: 'center', textAlign: 'center', alignItems: 'center' }}>
                                ...
                                <div>
                                    <p>
                                        ...
                                        <p style={{ fontSize: '14px', marginBottom: '0' }}>Pedido enviado</p>
                                    </p>
                                </div>
            ...
            >
                <ModalBody>
                    <ModalDetallePedido closeModalDetallePedido={closeModalDetallePedido} orderDetalleId={orderDetalleId} />
                </ModalBody>
            </Modal>
        </>
    )
