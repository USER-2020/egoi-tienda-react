            ...
            {products && products.length > 0 ? (
                <div className='container'>
                    <div className='containerRecents'>
                        ...
                        <div className={products && products.length > 0 ? 'containerProductos1' : 'containerProductos2'} ref={containerRef}>
                                        ...
                                        <a href='#' className='containerCard' key={index}>
                                            <Card className='cardProducto1' style={{ height: "380px" }}>
                                                <Link to={`/detailsProduct/${product.id}/${product.slug}`} >
                                                    ...
                                                    <CardImg top width="80%" src={baseUrlImage + product.thumbnail} alt={product.name} />
                                                    ...
                                                    <CardBody>
                                                        ...
                                                        {product.price >= 79990 || product.discount_valor >= 79900 || product.dicount_tag_valor >= 79900 ? (
                                                        ...
                                                        <CardTitle tag="h5">
                                                            {product.discount_tag_valor > 0 || product.discount_valor > 0 ? (
                                                                <div style={{ display: 'flex', flexDirection: 'row', gap: '15px', alignSelf: 'center' }}>
                                                                    ...
                                                                    <h5 id='tachado'><s>${product.price && product.price.toLocaleString('es')}</s></h5>
                                                                </div>
                                                            ) : (
                                                                <h5>${product.price && product.price.toLocaleString('es')}</h5>
                                                            )}
                                                        </CardTitle>
                                                    </CardBody>
                                                </Link>
                                                <Button
                                                    onClick={(e) => { e.preventDefault(); window.location.href = '/detailCart' }}
                                                    style={{
                                                        position: "absolute",
