          ...
          <div className="userInteraction">
            ...
            <div className="dropdown">
              <button
                ...
                style={{ textDecoration: 'none', color: 'black', border: 'none', backgroundColor: 'inherit', transform: 'translate(15px, 14px)', pointerEvents: shouldBtnCart ? 'none' : 'auto', display: shouldBtnCart ? 'none' : 'block' }}>
