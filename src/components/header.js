...
const Header = ({ cantCart, detailInfoPerfil, setIsLoggedInPartner, productsInCart, getAllProductsByCart, getAllProductsByCartNotoken, minQty, handleShowOffCanvas, handleShowOffCanvasClose, changueOffCanvasCart }) => {
  ...
  const handleOutsideOffcanvas = (event) => {
    ...
    <>
      <nav className="container">
          ...
          <div className="userInteraction">
            ...
            <div className="dropdown">
              <button
                ...
                style={{ textDecoration: 'none', color: 'black', border: 'none', backgroundColor: 'inherit', transform: 'translate(15px, 14px)', pointerEvents: shouldBtnCart ? 'none' : 'auto', display: shouldBtnCart ? 'none' : 'visible' }}>
        ...
        <div className="containerHeader">
          ...
          <Link to={`/discountedProducts`} className="option">
            <span className="option">
              <svg
                width="32"
                height="32"
            ...
            <div className="menuSeller">
              {isLoggedIn ? (
                <button onClick={() => {
                  setCurrentUser();
                  setIsLoggedIn(false);
                }} style={{ fontSize: '14px' }} className="logguedInfoBtn">
                  <FontAwesomeIcon icon={faRightFromBracket} />
